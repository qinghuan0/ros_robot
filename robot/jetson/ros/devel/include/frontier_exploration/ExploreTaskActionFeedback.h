...
bool operator==(const ::frontier_exploration::ExploreTaskActionFeedback_<ContainerAllocator1> & lhs, const ::frontier_exploration::ExploreTaskActionFeedback_<ContainerAllocator2> & rhs)
{
