...
class ExploreTaskActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExploreTaskGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExploreTaskGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExploreTaskActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ExploreTaskGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ExploreTaskGoal()
    }
