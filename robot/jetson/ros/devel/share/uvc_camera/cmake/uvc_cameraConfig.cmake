...
if("TRUE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /home/qinghuan/qh_ros/Team/robot/robot/jetson/ros/src/third_packages/camera_umd/uvc_camera)
  set(uvc_camera_DEVEL_PREFIX /home/qinghuan/qh_ros/Team/robot/robot/jetson/ros/devel)
  ...
  set(uvc_camera_INSTALL_PREFIX /home/qinghuan/qh_ros/Team/robot/robot/jetson/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qinghuan/qh_ros/Team/robot/robot/jetson/ros/src/third_packages/camera_umd/uvc_camera/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(uvc_camera_EXPORTED_TARGETS ${${uvc_camera_dep}_EXPORTED_TARGETS})
endforeach()
