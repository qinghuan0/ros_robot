...
echo_and_run cd "/home/nano/ros_car/src/third_packages/rbx1/rbx1_vision"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nano/ros_car/src/third_packages/rbx1/rbx1_vision/setup.py" \
     \
    build --build-base "/home/nano/ros_car/build/third_packages/rbx1/rbx1_vision" \
    install \
    --root="${DESTDIR-/}" \
