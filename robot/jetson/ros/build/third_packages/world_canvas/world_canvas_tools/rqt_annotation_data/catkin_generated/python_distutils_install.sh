...
echo_and_run cd "/home/nano/ros_car/src/third_packages/world_canvas/world_canvas_tools/rqt_annotation_data"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nano/ros_car/src/third_packages/world_canvas/world_canvas_tools/rqt_annotation_data/setup.py" \
     \
    build --build-base "/home/nano/ros_car/build/third_packages/world_canvas/world_canvas_tools/rqt_annotation_data" \
    install \
    --root="${DESTDIR-/}" \
